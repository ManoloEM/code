...
<p align="center"><em>Izquierda: ataque con para red suavizada con β = 20.0 mediante mascara de texto "Universidad De Sevilla". &nbsp;|&nbsp; Derecha:  ataque con para red suavizada con β = 1.0 mediante mascara de texto "Universidad De Sevilla".</em></p>

<p align="center">
  <img src="tfm/imagenes/ssim_comparison_b=20.png" width="45%" alt="Análisis del ataque adversario β=20.0"/>
  &nbsp;&nbsp;
  <img src="tfm/imagenes/ssim_comparison_b=1.png" width="45%" alt="Análisis del ataque adversario β=1.0"/>
</p>
<p align="center"><em>Izquierda: ataque con para red suavizada con β = 20, perturbación añadida reducida. &nbsp;|&nbsp; Derecha:  ataque con para red suavizada con β = 1.0, perturbación añadida mayor pero sigue siendo imperceptible (SSIM > 95%). </em></p>
